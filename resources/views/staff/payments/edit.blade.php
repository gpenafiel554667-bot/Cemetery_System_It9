    ...
    <form method="POST" action="{{ route('staff.payments.update', $payment) }}">
        ...
        <div class="grid grid-cols-2 gap-4">
            ...
            <div>
                ...
                <input type="number" step="0.01" name="amount" value="{{ old('amount', $payment->amount) }}" class="w-full border rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400" required>
