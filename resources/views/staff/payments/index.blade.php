...
<div class="mb-6 flex justify-between items-center">
    ...
    <a href="{{ route('staff.payments.create') }}" class="bg-gray-900 text-white px-5 py-2.5 rounded-lg text-sm font-semibold hover:bg-gray-700 transition">Add Payment</a>
</div>
