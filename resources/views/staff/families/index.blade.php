            ...
            <tr class="hover:bg-gray-50 transition">
                ...
                <td class="px-6 py-4">
                    <div class="flex gap-2">
                        <a href="{{ route('staff.families.show', $family) }}" class="bg-gray-100 text-gray-700 px-3 py-1.5 rounded-lg text-xs font-semibold hover:bg-gray-200 transition">View</a>
                        <a href="{{ route('staff.families.edit', $family) }}" class="bg-blue-50 text-blue-700 px-3 py-1.5 rounded-lg text-xs font-semibold hover:bg-blue-100 transition">Edit</a>
                    </div>
                </td>
            </tr>
            @empty
