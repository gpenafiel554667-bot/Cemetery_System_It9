...
@section('content')
<div class="mb-6">
    <h1 class="text-3xl font-bold text-gray-800">Add Family Record</h1>
</div>

<div class="bg-white rounded-xl shadow p-6 max-w-2xl">
    <form method="POST" action="{{ route('staff.families.store') }}">
        @csrf
        <div class="grid grid-cols-2 gap-4">
            ...
            <div>
                ...
                <input type="text" name="relationship" value="{{ old('relationship') }}" placeholder="e.g. Spouse, Child, Sibling" class="w-full border rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400" required>
            ...
            <div>
                ...
                <input type="text" name="contact_number" value="{{ old('contact_number') }}" class="w-full border rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400" required>
            ...
            <div class="col-span-2">
                ...
                <input type="email" name="email" value="{{ old('email') }}" class="w-full border rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400">
            ...
            <div class="col-span-2">
                ...
                <textarea name="address" rows="2" class="w-full border rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400">{{ old('address') }}</textarea>
            </div>
        </div>
