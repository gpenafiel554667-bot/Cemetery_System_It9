...
<div class="mb-6 flex justify-between items-center">
    ...
    <div class="flex gap-2">
        <a href="{{ route('admin.deceased.edit', $deceased) }}" class="bg-yellow-500 text-white px-4 py-2 rounded-lg hover:bg-yellow-600">Edit</a>
        <a href="{{ route('admin.deceased.index') }}" class="bg-gray-200 text-gray-800 px-4 py-2 rounded-lg hover:bg-gray-300">Back</a>
    </div>
</div>
...
<div class="bg-white rounded-xl shadow p-6 max-w-2xl">
    ...
    <p class="font-semibold text-gray-800">{{ \Carbon\Carbon::parse($deceased->date_of_birth)->format('F d, Y') }}</p>
</div>
<div>
    <p class="text-gray-500 text-sm">Date of Death</p>
    <p class="font-semibold text-gray-800">{{ \Carbon\Carbon::parse($deceased->date_of_death)->format('F d, Y') }}</p>
</div>
