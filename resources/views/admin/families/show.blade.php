...
<div class="mb-6 flex justify-between items-center">
    ...
    <div class="flex gap-2">
        <a href="{{ route('admin.families.edit', $family) }}" class="bg-yellow-500 text-white px-4 py-2 rounded-lg hover:bg-yellow-600">Edit</a>
        <a href="{{ route('admin.families.index') }}" class="bg-gray-200 text-gray-800 px-4 py-2 rounded-lg hover:bg-gray-300">Back</a>
    </div>
</div>
...
<div class="bg-white rounded-xl shadow p-6 max-w-2xl">
    <div class="grid grid-cols-2 gap-4">
        ...
        <div>
            <p class="text-gray-500 text-sm">Linked Deceased</p>
            <p class="font-semibold text-gray-800">
                {{ $family->deceased ? $family->deceased->first_name . ' ' . $family->deceased->last_name : 'N/A' }}
            </p>
        </div>
