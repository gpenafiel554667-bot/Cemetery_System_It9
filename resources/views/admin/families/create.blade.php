    ...
    <form method="POST" action="{{ route('admin.families.store') }}">
        ...
        <div class="grid grid-cols-2 gap-4">
            ...
            <div>
                ...
                <input type="text" name="relationship" value="{{ old('relationship') }}" class="w-full border rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-gray-400" required>
            ...
            <div class="col-span-2">
                ...
                <textarea name="address" rows="3" class="w-full border rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-gray-400">{{ old('address') }}</textarea>
